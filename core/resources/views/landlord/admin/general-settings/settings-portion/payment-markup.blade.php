       ...
       'instamojo'=> [
        ...
        'paytabs'=> [
            [
                ...
                'info' => 'if your currency is not available in PayTabs, it will convert you currency value to USD value based on your currency exchange rate.',
                'name'=> 'paytabs',
                'logo'=> 'paytabs_logo',
                'fields'=> ['paytabs_profile_id','paytabs_server_key','paytabs_region','egy_to_usd_exchange_rate']
            ]
        ],
    ];
@endphp