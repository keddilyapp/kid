...
@section('content')
    ...
    <section class="order-service-page-content-area bg-black padding-top-70 padding-bottom-100">
        <div class="container">
                ...
                <div class="col-lg-4 mt-4">
                    <div class="single-price-plan-item  bg-black">
                        ...
                        <div class="price-footer pb-3  bg-black" style="border-bottom: 5px solid #8e8686;">
                            @php
                        ...
                        <h3 class="signin-contents-title mt-4 bg-black ">{{get_static_option('order_page_form_title')}}</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group single-input mt-4">
                                            ...
                                            <select class="form-select form--control subdomain bg-black" id="subdomain"
                                                    name="subdomain">
                                                <option
...
<div class="mt-4">
    <input name="terms_condition" id="terms_condition" class="terms_condition"
           type="checkbox">
    <label for="terms_condition">{{__('I have read and agree to the website terms and conditions')}}
        <x-fields.mandatory-indicator/>
    </label>
</div>

<div class="col-lg-12 mt-7">
    <div class="form-group btn-wrapper"> <button class="boxed-btn btn-saas btn-block order-btn cmn-btn cmn-btn-bg-1"
