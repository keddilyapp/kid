...
class PaymentGateways
{
    ...
    private function exchange_rate_usd_to_egy(){
        $global_currency = get_static_option('site_global_currency');
        $egy_exchange_rate = get_static_option('site_' . strtolower($global_currency) . '_to_egy_exchange_rate');
        $checked_currency_rate = empty($egy_exchange_rate) ? 30.92 : $egy_exchange_rate;
    ...
    public function paytabs_ipn()
    {
        ...
        $global_currency = get_static_option('site_global_currency');
        $setCurrency = 'EGP'; // PayTabs requires Egyptian Pounds
        ...
        $paytabs->setExchangeRate($this->exchange_rate_usd_to_egy());
